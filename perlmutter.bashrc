...
function compileFMS {
        ...
        (cd build/intel/shared/repro/; source ../../env; make clean; time make NETCDF=3 REPRO=1 libfms.a)
        cd $folder
}
...
../../../../src/mkmf/bin/mkmf -t ../../../../src/mkmf/templates/perlmutter.mk -o '-I../../shared/repro' -p MOM6 -l '-L../../shared/repro -lfms' path_names)
        (cd build/intel/ocean_only/repro/; source ../../env; make clean; time make NETCDF=3 REPRO=1 MOM6)
        cd $folder
}
